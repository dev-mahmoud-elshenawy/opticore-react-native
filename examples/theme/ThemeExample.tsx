        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <View style={[styles.row, { marginTop: spacing.sm }]}>
                    <TouchableOpacity
                        style={[styles.button, { flex: 1, marginRight: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border }]}
            ...
            <View style={styles.card}>
                ...
                {renderTypography("Heading 2", typography.sizes.h2, typography.weights.semibold, colors.text)}
                {renderTypography("Body 1", typography.sizes.md, typography.weights.regular, colors.text)}
                {renderTypography("Caption", typography.sizes.sm, typography.weights.regular, colors.textSecondary)}
            </View>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.paletteContainer}>
                    {[
                        ...
                        <View key={item.name} style={{ alignItems: 'center', marginRight: spacing.md, marginBottom: spacing.sm }}>
                            <View style={[styles.colorBox, { backgroundColor: item.color }]} />
                            <Text style={{ fontSize: typography.sizes.xs, color: colors.textSecondary }}>{item.name}</Text>
                        </View>
                    ))}
                </View>
            </View>
