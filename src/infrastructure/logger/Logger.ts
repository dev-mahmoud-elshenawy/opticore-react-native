...
export class Logger implements ILogger {
    ...
    private print(level: LogLevel, message: string, args: unknown[], error?: Error): void {
        ...
        switch (level) {
            case LogLevel.DEBUG: colorPrefix = '\x1b[90m'; break;
            case LogLevel.INFO: colorPrefix = '\x1b[34m'; break;
            case LogLevel.WARN: colorPrefix = '\x1b[33m'; break;
            case LogLevel.ERROR: colorPrefix = '\x1b[31m'; break;
        }
